...
- [⚙️ **Configuration**](/docs/en/framework/getting-started/configuration): See how to configure global middlewares via `azura.config.ts`.
- [🚨 **Error Handling**](/docs/en/framework/features/error-handling): Understand how error middlewares can be used to centralize exception handling.
