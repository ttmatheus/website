...
- [🧬 **Type Extensions**](/docs/en/advanced/type-extensions): Learn how to extend AzuraJS types for your specific needs.
- [📦 **Modular Imports**](/docs/en/advanced/modular-imports): Optimize your bundle by leveraging TypeScript's modularity.
