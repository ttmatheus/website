...
- [🔌 **Middleware**](/docs/en/concepts/middleware): Understand how middlewares can populate extended request properties.
- [🚨 **Error Handling**](/docs/en/features/error-handling): See how to use `HttpError` for consistent error responses.
