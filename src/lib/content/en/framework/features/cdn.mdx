...
- [⚙️ **Configuration**](/docs/en/getting-started/configuration): See how to configure the `cdn` object in your configuration file.
- [🛡️ **Rate Limiting**](/docs/en/features/rate-limiting): Protect your CDN administration endpoints with Rate Limiting.
