...
- [⚡ **Cluster Mode**](/docs/en/features/cluster-mode): Combine the proxy with cluster mode for high availability.
- [🌐 **CORS**](/docs/en/features/cors): Use the proxy to resolve CORS issues between different origins.
